...
export const PopoverBody = React.forwardRef((props, ref) => {
    ...
    return (React.createElement("div", { "aria-describedby": innerId, className: classNames({
        ...
        }), id: `rpv-core__popover-body-${ariaControlsSuffix}`, ref: mergedContentRef, role: "dialog", tabIndex: -1 },
        React.createElement(Arrow, { customClassName: styles.bodyArrow, position: position }),
